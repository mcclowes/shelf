/**
 * ---
 * purpose: Describe Atlas's public command contract for offline introspection and help.
 * ---
 */
...
export const contract = {
  name: 'atlas', version: '0.1.0', description: 'Index your repositories so agents get context on other projects without walking the filesystem.',
  ...
  global_args: [
    ...
    { name: '--version', type: 'boolean', description: 'Show Atlas version.' },
  ],
  commands: [
    ...
    { name: 'sync', description: 'Write the global atlas agent skill.', mutating: true, args: [arg('--skills-dir', 'Destination directory; defaults to ~/.claude/skills.')] },
    { name: 'schema', description: 'Describe Atlas offline.', mutating: false, args: [] },
    { name: 'capabilities', description: 'Alias for Atlas schema introspection.', mutating: false, args: [] },
  ],
